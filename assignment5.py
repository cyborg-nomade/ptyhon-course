...
random_number_between_0_and_1 = random()
random_number_between_1_and_10 = random() * 10 + 1
print(random_number_between_0_and_1, random_number_between_1_and_10)

# 2) Use the datetime library together with the random number to generate a random, unique value.
random_ordinal = round(
    random() * datetime.date.max.toordinal() + datetime.date.min.toordinal()
)
